...
class YahooStock(Stock):
    ...
    def scrape(self):
        ...
        for stock_dividend in reversed(stock_dividends):
                ...
                stock_dividends_recover_get = stock_dividend.find('div',{"class":'Fxg(1) Fxs(1) Fxb(0%) Ta(end) Mend($m-table-cell-space) Mend(0):lc Miw(70px)'})
                stock_dividends_recover = stock_dividends_recover_get[0].get_text()
